...
export default function QuestionThree({ navigateToPage, addPoints, ...props }) {
    ...
    const handleAnswerClick = (selectedAnswer) => {
        addPoints(selectedAnswer === true_false_questions[0].correct_answer ? 100 : 0)
        navigateToPage('q4', props);
    };
